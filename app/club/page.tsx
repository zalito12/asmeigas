...
import { Check, Dot, HeartHandshake, Smile, Sparkles, Trophy, WandSparkles, WavesLadder } from 'lucide-react';
...
const tiers = [
  ...
  },
  {
    ...
    benefits: [
      ...
      'Gorro e bañador', 'Camiseta', 'Sudadera',
    ],
    popular: true
  },
  {
    ...
    benefits: ['Gorro e bañador', 'Camiseta', 'Sudadera', 'Nome nos seguidores'],
    donation: false
  },
  /* {
    title: 'Altruista',
    price: '?',
    description: 'Fai un donativo',
    benefits: ['Mellorar materiais', 'Axudar cos costes', 'Sacarnos un sorriso'],
    donation: true,
  }, */
];
            ...
            <Card className="text-primary-foreground p-6">
              <div className="w-full flex flex-col md:flex-row  items-center gap-4">
                <div className="flex-grow">
                  <p>Tamén podes facer maxia cun donativo da cantidade que ti queiras</p>
                  <div className="mt-4">
                    <ReadMore caption="+ Saber máis">
                      As donacións axudannos a seguir crecendo e continuar a nosa andanza.
                      <ul className="ml-4 lg:ml-8 ">
                        <li className="flex items-start"><WandSparkles className="w-4 h-4 mx-2 mt-1 shrink-0"></WandSparkles>Acoller a máis meigas</li>
                        <li className="flex items-start"><Trophy className="w-4 h-4 mx-2 mt-1 shrink-0"></Trophy>Axudar cos costes das competicións</li>
                        <li className="flex items-start"><WavesLadder className="w-4 h-4 mx-2 mt-1 shrink-0"></WavesLadder>Mellorar os materiais e acceso a instalacións</li>
                        <li className="flex items-start"><Smile className="w-4 h-4 mx-2 mt-1 shrink-0"></Smile>Sacarnos un sorriso</li>
                      </ul>
                    </ReadMore>
                  </div>
                </div>
