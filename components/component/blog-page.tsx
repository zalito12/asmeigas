        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">Latest Blog Posts</div>
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Dive Into Our Aquatic Adventures</h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Explore our latest blog posts and discover the thrilling world of the Aqua Swim Club.
              </p>
            </div>
          </div>
